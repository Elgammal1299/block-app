    ...
    fun preloadInstalledAppIcons() {
        Thread {
            try {
                ...
                Log.i("IconCacheManager", "Preloaded ${preloadedApps.size} app icons")
            } catch (e: Exception) {
                Log.e("IconCacheManager", "Error preloading icons", e)
            }
        }.start()
    }
    ...
    fun preloadAppIcons(packageNames: List<String>) {
        Thread {
            try {
                ...
                Log.i("IconCacheManager", "Preloaded ${packageNames.size} specific app icons")
            } catch (e: Exception) {
                Log.e("IconCacheManager", "Error preloading specific icons", e)
            }
        }.start()
    }
